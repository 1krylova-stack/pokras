...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
  <head>
	...
	<link rel="preload" as="image" href="/wp-content/themes/shablon/img/head_bg.jpg" fetchpriority="high">
    ...
    <link rel="preload" as="style" href="<?php bloginfo('template_url')?>/js/owl.carousel/assets/owl.carousel.css" onload="this.onload=null;this.rel='stylesheet'">
<noscript><link rel="stylesheet" href="<?php bloginfo('template_url')?>/js/owl.carousel/assets/owl.carousel.css"></noscript>

<link rel="preload" as="style" href="<?php bloginfo('template_url')?>/js/fancybox/jquery.fancybox.css" onload="this.onload=null;this.rel='stylesheet'">
<!-- preload фона только на >= 1024px -->
<link rel="preload" as="image"
      href="/wp-content/themes/shablon/img/head_bg.jpg"
      media="(min-width: 1024px)"
      fetchpriority="high">
<noscript><link rel="stylesheet" href="<?php bloginfo('template_url')?>/js/fancybox/jquery.fancybox.css"></noscript>


    <!-- СЛОИ: гарантируем, что шапка/меню выше героя; фикс-плашка — только на мобилке -->
    <style>
      /* Меню/шапка поверх секции героя */
      #header, #top, #main_nav { position: relative; z-index: 20; }
      #head_content { position: relative; z-index: 1; }

      /* Фикс-плашка телефона: фиксируем ТОЛЬКО на мобилке, иначе статична */
      .mobile_fixed_phone_wrap { position: static; z-index: auto; }
      @media (max-width: 767px){
        .mobile_fixed_phone_wrap { position: fixed; top: 0; left: 0; right: 0; z-index: 9999; }
        /* Отступ ниже фикс-плашки, чтобы она не наезжала на контент */
        body.inner_page #head_content { padding-top: 56px; } /* при необходимости подстройте высоту */
      }
    </style>

    <!-- Facebook Pixel Code (как было) -->
    <script>
  ...
  <body <?php body_class($page_classes)?>>
    ...
    <!-- ИСПРАВЛЕНО: один корректный блок (убран вложенный дубликат mobile_fixed_phone_wrap) -->
        ...
        <div class="center_wrap">
          <div class="dt">
            ...
            <div class="dtc vat ss_icon_link">
              <a href="whatsapp://send?phone=79673444222"><img src="/wp-content/themes/shablon/img/footer_whatsapp_icon.png" alt=""></a>
              <a href="https://vk.com/pokrasautospb"><img src="/wp-content/themes/shablon/img/footer_vk_icon.png" alt=""></a>
              <a href="https://www.instagram.com/pokrasautospb.ru/"><img src="/wp-content/themes/shablon/img/footer_instagram_icon.png" alt=""></a>
            </div>
            <div class="dtc vat head_address" itemscope itemtype="http://schema.org/Organization">
              <p><span itemprop="address"><?php the_field('head_address', 'options')?></span></p>
            </div>
            ...
            <div class="dt">
              ...
              <div class="dtc vab head_order_social">
                ...
                <p class="head_order_social_icons">
                  <a href="https://wa.me/79673444222">
